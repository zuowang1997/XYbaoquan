...
<script language="JScript" event="OnCompleted(hResult,pErrorObject, pAsyncContext)" for=foo>
 document.forms[0].check_sourcenumber.value=unescape(MACAddr);
...
<div class="jumbotron">
    ...
    <div class="col-sm-4">
      		<div class="input-group" style="width:700px">
  				<input type="radio" style="margin-left:60px; margin-top:8px;" name="check_AuthenticationType" value="only_data" />数据认证
                <br/><br/>
                <input type="radio" style="margin-left:60px; margin-top:8px;" name="check_AuthenticationType" value="only_device" />数据认证+源认证
                <br/>
  ...
  <br/>
    ...
    <div class="col-sm-4">
      		<div class="input-group">
  				<input type="hidden" class="form-control" name="check_sourcenumber"  readonly="readonly" />
			</div>
    </div>
  </div>
  <br/><br/>
