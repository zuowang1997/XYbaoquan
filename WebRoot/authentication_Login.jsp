   ...
   <form action="UserLogin" method="POST" name="myform"> 
    <section class="loginForm"> 
     ...
     <div class="loginForm_content"> 
      <fieldset> 
       <div class="inputWrap"> 
        <input type="text" name="userlogin_username" id="userlogin_username" placeholder="请输入ID" required="" autofocus /> 
       </div> 
       <div class="inputWrap"> 
        <input type="password" name="userlogin_password" id="userlogin_password" placeholder="请输入密码" required="" /> 
       </div> 
      </fieldset> 
      <fieldset> 
