...
<div class="jumbotron">
    ...
    <div class="col-sm-4">
      		<div class="input-group" style="width:700px">
  				<input type="radio" style="margin-left:60px; margin-top:8px;" name="check_AuthenticationType" value="only_data" />认证数据
                <br/><br/>
                <input type="radio" style="margin-left:60px; margin-top:8px;" name="check_AuthenticationType" value="only_time" />认证原文
                <br/>
