...
public class YanZheng_Client extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		    ...
		    //用rsa和hash核对数据
		    /*
		    String get_data = FileDeviceNumber + FileFinishTime + CerNumber + AuthenticationType + WORDorPIC;
		    String get_data_hash = newcertificate.doHash(get_data);
		    String real_hash_encryped = String.valueOf(request.getSession().getAttribute("fromclient_hash"));
		    RSA hashrsa = new RSA();
