...
public class CAsimulation_time extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CAsimulation_time() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String mi_after1Hash = String.valueOf(request.getSession().getAttribute("mi_after1Hash_time"));
		...
		if(ca.checkHashCode(ming_Hashcode)){ 
			...
			boolean res_time = ca_time.addFileFingerprint_Time(userid,securitytime,after2Hash);
			boolean res_time2 = ca_time.addTimestamp_Time(after2Hash,unixtimestmap);
			if((res_time != false)&(res_time2 != false)){
		...
		session.setAttribute("afterCA_Footprint_time", mi_afterCA_Footprint); 
