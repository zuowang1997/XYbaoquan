...
public class YanZheng_notURL extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	        ...
	        //读文件
	        File UserFile = new File("C:\\Tomcat\\webapps\\XYbaoquan\\upload\\"+FileNameWithFormat);
		    //接收ID和时间
		  ...
		  //补全保全时间
		    int timelong1 = SeTime_str.length();
			if(timelong1 == 21){
				SeTime_str = SeTime_str+"00"; 
			}
            if(timelong1 == 22){
            	SeTime_str = SeTime_str+"0"; 
			}
		    String SeTime = SeTime_str;
		    //接收类型
		    AuthenticationType = String.valueOf(request.getSession().getAttribute("check_AuthenticationType"));
		    
		     		    
		    //�õ��ļ���
		    String FileName_f = UserFile.getName();
		    String FileName = FileName_f.substring(0,FileName_f.length()-4);
            ...
            //�鿴Ҫ��֤���ļ���������ʽ�Ļ���ͼƬ��ʽ��
            String WORDorPIC = String.valueOf(request.getSession().getAttribute("YanZhengMiddle_FileType"));
            System.out.println("文件类型文件类型文件类型："+WORDorPIC);
            ...
            else if( WORDorPIC.equals("pdf") )
		    {
                ...
                int pagenumber = DealWithPDF.setup(UserFile);
            ...
            else if( (WORDorPIC.equals("jpg")) | (WORDorPIC.equals("png")) )
            {
	           ...
	           System.out.println("没有选择文件类型");
	           session.setAttribute("fail_reason", "您没有选择数据类型是文字还是图片！");
            }
             ...
             //只认证数据的if结束了
                ...
                if(AuthenticationType.equals("only_time")){
            		...
            		//String FileFinishTime = filehandle.GetFileFinishTime(UserFile);
       			      String FileFinishTime = String.valueOf(request.getSession().getAttribute("Authentication_FinishTime"));
                ...
                if(AuthenticationType.equals("only_device")){
            		...
            		FileDeviceNumber = String.valueOf(request.getSession().getAttribute("check_sourcenumber"));
