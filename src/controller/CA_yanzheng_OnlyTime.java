...
public class CA_yanzheng_OnlyTime extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CA_yanzheng_OnlyTime() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String mi_Hashcode = String.valueOf(request.getSession().getAttribute("yanzheng_mi_OnlyTime_after1Hash"));
		String mi_userid = String.valueOf(request.getSession().getAttribute("yanzheng_mi_OnlyTime_userid"));
		String mi_securitytime = String.valueOf(request.getSession().getAttribute("yanzheng_mi_OnlyTime_setime"));
		...
		try {
			...
			System.out.println("CA收到指纹："+ming_Hashcode+"用户ID："+ming_userid+"保全时间："+ming_securitytime);
		} catch (Exception e) {
		...
		*/
		String Timestamp = sqlca.getTimeStamp_TimebyKey(ming_userid,ming_securitytime);
		...
		session.setAttribute("yanzheng_time_afterCA_Footprint", mi_afterCA_Footprint); 
		session.setAttribute("yanzheng_time_afterCA_timestamp", mi_unixTimestamp); 
